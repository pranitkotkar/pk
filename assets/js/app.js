...
<a class="navbar-brand" href="index.html">Pranit Kotkar </a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >The expert in anything was once a beginner.</p>
    </div>
    ...
    <a class="social-button linkedin" href="http://linkedin.com/in/pranit-kotkar-4b64b51a4" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/pranitkotkar" target="_blank">
    ...
    <a class="social-button github"  href="mailto:pranitkotkar09@gmail.com" target="_blank" >
    <!-- SVG code for Github icon -->
